...
data = pd.read_csv(r"D:\Singapore Resale Flat Prices Predicting\mrt.csv")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                with open(r"C:\Users\Aakash\modelsml.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open(r"C:\Users\Aakash\scalersml.pkl", 'rb') as f:
